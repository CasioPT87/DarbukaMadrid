...
const homeText = {
    ...
    La cultura árabe nace mucho antes del llamado “periodo de idolatría” (Siglo VI). En este período las culturas griega, romana, bizantina y persa gozaban de su máximo esplendor.
    ...
    text_3: `Nuba, Wasla, Malouf difieren en el tipo de poemas que utilizan y en los ritmos. En la Nuba se utilizan poemas nacidos en Al-Ándalus (Zajal, Muwashahah, Dawr etc.) en la Wasla y Malouf también utilizan estos y otros (Qasida, Mawal, Dawr, etc.)
